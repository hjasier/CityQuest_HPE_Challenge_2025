  ...
  return (
    <ScrollView className="flex-1 bg-gray-50">
      ...
      <View className="bg-secondary pt-12 pb-10 rounded-b-3xl shadow-md">
        <View className="flex-row justify-between items-center px-6">
          <View>
            ...
            <Text className="text-white text-sm opacity-80">Manage your account</Text>
          </View>
          <View className="bg-white/20 px-4 py-2 rounded-full">
            <Text className="text-white font-bold">{userPoints} Points</Text>
          </View>
        </View>
      </View>
      ...
      <View className="mx-4 -mt-6 bg-white p-4 rounded-xl shadow-sm shadow-gray-700">
        <View className="flex-row items-center space-x-4">
          ...
          <View className="flex-1">
            ...
            >
              <Text className="text-blue-700 text-sm font-medium">Edit Profile</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
      ...
      <View className="mt-6 mx-4 bg-white rounded-xl shadow-sm">
        <Text className="text-lg font-bold text-gray-800 p-4 border-b border-gray-100">Groups</Text>
        ...
        >
          <View className="flex-row items-center">
            ...
            <Text className="text-gray-700 font-medium">Create a collaborative group</Text>
          </View>
        ...
        >
          <View className="flex-row items-center">
            ...
            <Text className="text-gray-700 font-medium">Join a group</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color="#9ca3af" />
        </TouchableOpacity>
      </View>
      ...
      {/* Account section */}
      <View className="mt-6 mx-4 bg-white rounded-xl shadow-sm">
        <Text className="text-lg font-bold text-gray-800 p-4 border-b border-gray-100">Account</Text>
      ...
      >
        <Text className="text-red-600 text-center font-medium">Log Out</Text>
      </TouchableOpacity>
    </ScrollView>
  )
}
